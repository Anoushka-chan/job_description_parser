...
def main():
    ...
    post = {
            "content": "non_recognized_words",
            "data": non_recognized_words,
            "date": datetime.datetime.utcnow()
            }
    posts = db.posts
    posts.insert(post)
    ObjectId('...')
    posts.find_one({"content": "non_recognized_words"})
    {u'date': datetime.datetime(...), u'text': u'My first blog post!', u'_id': ObjectId('...'), u'content': u'non_recognized_words'}
